            ...
            <form class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <select class="form-select" id="QuienConcede" required>
                        ...
                        <option>SUPERVISOR - JESÚS MANUEL GAMBOA LEYVA</option>
                    </select>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" maxlength="255" class="form-control" placeholder="Escribir el trabajo a realizar"
                        id="TrabajoRealizar" required>
                </div>
                <br>
                <div class="col-md-80">
                    <legend for="Instrucciones" class="form-label">INSTRUCCIONES ESPECIFICAS:</legend>
                    <input type="text" maxlength="255" class="form-control"
                        placeholder="Escribir detalladamente las instrucciones del trabajo a realizar" id=" Instrucciones"
                        required>
                </div>
                <div class="container">
                    <br>
                ...
                <fieldset>
                    <div class="container-rigth">
                        <div class="col-md-4">
                            ...
                            <button class="btn btn-primary" type="submit">IMPRIMIR LICENCIA</button>
                        </div>
                    </div>
                </fieldset>
            </form>
